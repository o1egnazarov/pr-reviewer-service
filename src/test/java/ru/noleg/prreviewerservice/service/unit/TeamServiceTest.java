...
class TeamServiceTest {
  ...
  @InjectMocks private TeamServiceDefaultImpl teamService;

  @Test
  void createTeam_shouldSaveTeam_whenTitleIsUniqueAndMembersPresent() {
    // Arrange
    final String teamTitle = "Team A";
  ...
  void createTeam_shouldThrownException_whenUserAlreadyInTeam() {
    ...
    UserAlreadyExistException ex =
        assertThrows(
            UserAlreadyExistException.class, () -> teamService.createTeam(teamTitle, members));
  ...
  void getTeam_shouldThrowException_whenTeamNotFound() {
    // Arrange
    final String title = "Unknown Team";
    when(teamRepository.findByTitle(title)).thenReturn(Optional.empty());

    // Act | Assert
    NotFoundException ex = assertThrows(NotFoundException.class, () -> teamService.getTeam(title));
